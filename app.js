// ===== PRODUCT DATA =====
const products = [
  { id:1, name:"Crimson Bridal Silk", fabric:"Pure Kanjivaram Silk", price:"₹8,500", tag:"bridal", badge:"badge-bridal", badgeLabel:"Bridal", img:"assets/saree_red.png", desc:"Exquisite crimson Kanjivaram silk saree with heavy gold zari border, peacock pallu motifs, and rich blouse piece. A timeless choice for the modern bride." },
  { id:2, name:"Royal Blue Banarasi", fabric:"Banarasi Silk", price:"₹6,200", tag:"silk", badge:"badge-silk", badgeLabel:"Silk", img:"assets/saree_blue.png", desc:"Opulent royal blue Banarasi saree woven with intricate golden meenakari motifs and a stunning contrast border. Perfect for festive occasions." },
  { id:3, name:"Emerald Temple Drape", fabric:"Kanjivaram Silk", price:"₹9,800", tag:"bridal", badge:"badge-bridal", badgeLabel:"Bridal", img:"assets/saree_green.png", desc:"Heavy emerald green Kanjivaram with traditional temple border, rich pallu, and contrasting blouse. A South Indian bridal masterpiece." },
  { id:4, name:"Blush Sequin Chiffon", fabric:"Pure Chiffon", price:"₹3,400", tag:"party", badge:"badge-party", badgeLabel:"Party Wear", img:"assets/saree_pink.png", desc:"Delicate blush pink chiffon saree adorned with silver sequin embroidery throughout. Light as a feather and stunning under lights." },
  { id:5, name:"Sunlit Chanderi Bloom", fabric:"Chanderi Silk Cotton", price:"₹2,800", tag:"casual", badge:"badge-casual", badgeLabel:"Casual", img:"assets/saree_yellow.png", desc:"Golden yellow Chanderi silk-cotton saree with elegant block print motifs and thin golden border. Ideal for daytime functions and gifting." },
  { id:6, name:"Regal Purple Georgette", fabric:"Heavy Georgette", price:"₹4,600", tag:"party", badge:"badge-party", badgeLabel:"Party Wear", img:"assets/saree_purple.png", desc:"Deep purple designer georgette saree with heavy mirror and thread embroidery work. A showstopper for every celebration and reception." },
];
